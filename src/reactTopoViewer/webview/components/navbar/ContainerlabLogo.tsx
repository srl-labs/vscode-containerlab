/**
 * ContainerlabLogo - Animated logo component for the navbar.
 * Features:
 * - Hover animation: bubbles float and liquid waves
...
interface ContainerlabLogoProps {
  className?: string;
  /** Click progress (0-10), controls shake intensity and explosion */
  clickProgress?: number;
  /** Whether the logo has exploded */
  isExploded?: boolean;
}
